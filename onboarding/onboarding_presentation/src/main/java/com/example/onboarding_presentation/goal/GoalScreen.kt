   ...
   viewModel: GoalViewModel = hiltViewModel()
    ...
    Box(
        ...
        Column(
            ...
            Text(text = stringResource(id = com.example.core.R.string.your_goal),
        ...
        Spacer(modifier = Modifier.height(spacing.spaceMedium))
            ...
            Row{
                SelectableButton(
                    text = stringResource(id = com.example.core.R.string.lose),
                ...
                SelectableButton(
                    text = stringResource(id = com.example.core.R.string.keep),
                ...
                SelectableButton(
                    text = stringResource(id = com.example.core.R.string.gain),
