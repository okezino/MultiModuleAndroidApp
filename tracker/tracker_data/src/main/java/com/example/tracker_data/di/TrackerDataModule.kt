...
import com.example.tracker_data.local.db.TrackerDatabase
...
object TrackerDataModule {
    ...
    @Provides
    @Singleton
    fun provideTrackerRepository(trackerDatabase: TrackerDatabase, openFoodApi: OpenFoodApi): TrackerRepository {
